...
a persistence unit "Examen63PardoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Examen63Pardo/pom.xml":
...
artifact ("Examen63Pardo.war") is already built. You can build
